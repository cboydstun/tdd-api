...
export default function ProductList() {
    ...
    return (
      <>
        <Helmet>
          ...
          <meta name="description" content="Loading our selection of bounce houses and party equipment..." />
        </Helmet>
    ...
    return (
      <>
        <Helmet>
          ...
          <meta name="description" content="An error occurred while loading our products." />
        </Helmet>
        <div className="min-h-screen flex justify-center items-center">
  ...
  return (
    <>
      <Helmet>
        <title>Bounce Houses & Party Equipment Rentals | SATX Bounce House Rentals</title>
        <meta name="description" content="Browse our selection of bounce houses, water slides, and party equipment for rent in San Antonio. Filter by type, size, and price. Free delivery within Loop 1604!" />
        <meta name="keywords" content="bounce house rental, water slides, party equipment, San Antonio rentals, inflatable rentals, party supplies, event rentals" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="Bounce Houses & Party Equipment Rentals | SATX Bounce House Rentals" />
        <meta property="og:description" content="Browse our selection of bounce houses, water slides, and party equipment for rent in San Antonio. Free delivery within Loop 1604!" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(createProductListingSchema(filteredAndSortedProducts))}
        </script>
      </Helmet>
