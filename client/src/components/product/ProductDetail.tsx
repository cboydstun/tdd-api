  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="product:price:amount" content={product.price.base.toString()} />
        <meta property="product:price:currency" content={product.price.currency} />
        <meta property="product:availability" content={product.availability} />
        
        {/* Additional meta tags */}
        <meta name="keywords" content={`bounce house rental, ${product.name}, party rental, San Antonio, ${product.capacity} people, ages ${product.ageRange.min}-${product.ageRange.max}`} />
      </Helmet>
