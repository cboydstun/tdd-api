  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact SATX Bounce House Rentals for party equipment rentals in San Antonio. Free delivery within Loop 1604! Call us at 512-210-0194 or fill out our contact form." />
        <meta name="keywords" content="contact SATX Bounce House, bounce house rental contact, San Antonio party rentals, rental inquiry, free delivery, party equipment contact" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="Contact SATX Bounce House Rentals | San Antonio Party Equipment Rental" />
        <meta property="og:description" content="Contact us for bounce house rentals in San Antonio. Free delivery within Loop 1604! Available 7 days a week from 8am to 8pm." />
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-secondary-blue/5 p-6 rounded-lg">
                    ...
                    <p className="text-gray-600">
                      <a href="tel:512-210-0194" className="hover:text-primary-blue transition-colors">
                        512-210-0194
                      </a>
                    </p>
                  </div>
                  ...
                  <div className="rounded-lg overflow-hidden shadow-lg">
                    <iframe
                      ...
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d222334.34533324622!2d-98.57211767968823!3d29.45876528364436!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x865c58af04d00eaf%3A0x856e13b10a016bc!2sSan%20Antonio%2C%20TX!5e0!3m2!1sen!2sus!4v1733607158689!5m2!1sen!2sus"                       width="100%"
                      height="300"
                      style={{ border: 0 }}
